namespace QueryPack.ModelManager.Schema.Processing.Impl
{
    ...
    internal class CSharpCompilationServiceImpl : ICompilationService
    {
        public Assembly Compile(IEnumerable<string> sourceFiles, params Assembly[] referencedAssemblies)
        {
